defmodule Elixirer.LinkControllerTest do
  use Elixirer.ConnCase

  alias Elixirer.Post
  @valid_attrs %{comments_count: 42, title: "some content", url: "some content"}
  @invalid_attrs %{}
